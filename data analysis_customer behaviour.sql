...
-- Impact :-  -- 1. Helps priortize high-performing category
			  -- 2. Optimize inventory planing
              -- 3. Improves marketing ROI

-- ------------------------------------------------------------------------------------------
-- 2. Are discount actually increasing purchase value?alter
...
-- Impact :-   -- 1. Identify effectiveness of discounts
               -- 2. Reduce unnecessary discount cost
...
-- Impact     -- Improves product placement & recommendations
